...
module.exports = function (app) {
    ...
    app.route('/getpulbeicuser')
        .get(subscribedMgr.getAllCustomer);

    app.route('/getbusniessuser')
        .get(businessUserMgr.getAllBusinessUser);

    app.route('/getselectedbusniessuser/:id')
        .get(businessUserMgr.getSelectedBusinessUser);

    app.route('/getallreview')
        .get(reviewMgr.getReview);

    app.route('/getcurrentvisitorcount/:id')
        .post(businessUserMgr.getCurrentVistiorCount);

    app.route('/gettotalvisitorcount/:id')
        .get(businessUserMgr.getTotalVistiorCount);
    ...
    app.route('/deletesinglecompnanyimage/:id')
